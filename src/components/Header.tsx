...
export const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md py-4 shadow-lg shadow-slate-200/50 border-b border-slate-200' : 'bg-transparent py-6'}`}>
